 ...
 *	  It prints 0 because the child inherit the pid value 0 and the pid of child is set after Fork() returns.
 * 2. Remove the Exit () statement.  What happens, and why?
 *	  It prints two more lines: 2 and 0. Because the child still executes after the if clause.
 */
